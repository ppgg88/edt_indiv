    ...
    <body onload="nothing();">
        ...
        <div class="main">
            <table class="main">
                <tr class="main">
                    <td class="main">
                        <a href="import_data.php?key=<?php echo($key);?>&semaine=<?php echo($semaine);?>"><img onclick="nothing()" src="icon/cercle_importer.png" class="import main"/></a>
                    </td>
                    <td class="main">
                    ...
                    <td class="main">
                        <a href="parametre.php?key=<?php echo($key);?>&semaine=<?php echo($semaine);?>"><img onclick="nothing()" src="icon/cercle_parametres.png" class="param main"/></a>
                    </td>
                </tr>
                <tr class="main">
                    <td class="main">
                    ...
                    <td class="main">
                        <a href="new_rdv.php?key=<?php echo($key);?>&semaine=<?php echo($semaine);?>"><img onclick="nothing()" src="icon/cercle_rdv.png" class="rdv_new main"/></a>
                    </td>
                </tr>
                <tr class="main">
                    <td class="main">
